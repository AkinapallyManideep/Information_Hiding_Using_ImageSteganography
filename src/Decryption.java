//DecodeMessage.java
 ...
 {
 JButton open = new JButton("Open"), decode = new JButton("Extract"),
 ...
 /*public String Decryption(String skey) {
    this.skey2 = skey;
    return skey2;
}*/
...
private java.io.File showFileDialog(boolean open) {
 ...
 private void decodeMessage() {
   //skey =  JOptionPane.showInputDialog(" enter password");
    ...
    for(int i=0; i<len; i++)
     ...
     message.setText(new String(b));//prints the message on the screen 
     if(message.getText().isEmpty())
     {
      JOptionPane.showMessageDialog(null, "no message in it");
     }
